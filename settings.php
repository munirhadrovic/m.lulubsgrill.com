<?php
	$adresa="8795 Tamiami Trail North Naples, Fl, 34108"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2395945330;// Broj koji se poziva na dugme CALL US
